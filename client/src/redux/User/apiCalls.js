...
export const AddBookMark = (id)=>{
    return async (dispatch)=>{
        try {
            ...
            const response = await axios.put("http://localhost:5000/api/user/649a7b00cce571fc3561f5e4/bookmark",{id})
...
export const RemoveBookMark = (id)=>{
    return async (dispatch)=>{
        try {
            ...
            const response = await axios.delete("http://localhost:5000/api/user/649a7b00cce571fc3561f5e4/bookmark/"+id)
